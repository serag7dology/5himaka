            ...
            <div class="account-wrap-inner">
                <div class="account-left">
                    <ul class="list-inline account-sidebar">
                        ...
                        <li class="{{ request()->routeIs('account.products.index') ? 'active' : '' }}">
                            <a href="{{ route('account.products.index') }}">
                                <i class="las la-cart-arrow-down"></i>
                                {{ trans('storefront::account.pages.products') }}
                            </a>
                        </li>
                        ...
                        <li class="{{ request()->routeIs('account.history.index') ? 'active' : '' }}">
                            <a href="{{ route('account.history.index') }}">
                                <i class="lar la-bookmark"></i>
                                {{ trans('storefront::account.pages.wallet_history') }}
                            </a>
                        </li>
