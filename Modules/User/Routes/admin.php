...
Route::get('users/plans', [
    'as' => 'admin.users_plans.index',
    'uses' => 'PlanController@index',
    'middleware' => 'can:admin.users_plans.index',
]);

Route::get('users/plans/create', [
    'as' => 'admin.users_plans.create',
    'uses' => 'PlanController@create',
    'middleware' => 'can:admin.users_plans.create',
]);
Route::post('users/plans', [
    
    'as' => 'admin.users_plans.store',
    'uses' => 'PlanController@store',
    'middleware' => 'can:admin.users_plans.create',
]);
Route::get('users_plans/{id}/edit', [
    'as' => 'admin.users_plans.edit',
    'uses' => 'PlanController@edit',
    'middleware' => 'can:admin.users_plans.edit',

]);

Route::put('users_plans/{id}/edit', [
    'as' => 'admin.users_plans.update',
    'uses' => 'PlanController@update',
    'middleware' => 'can:admin.users.edit',
]);

Route::delete('users_plans/{ids?}', [
    'as' => 'admin.users_plans.destroy',
    'uses' => 'PlanController@destroy',
    'middleware' => 'can:admin.users_plans.destroy',
]);