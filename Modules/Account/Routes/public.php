...
Route::middleware('auth')->group(function () {
    ...
    Route::get('account/product', 'AccountDashboardController@products')->name('account.products.index');
    Route::post('account/add', 'AccountDashboardController@add')->name('account.products.add');
    ...
    Route::get('account/wallet-history', 'AccountWalletHistoryController@index')->name('account.history.index');
