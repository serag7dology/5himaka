...
Route::get('orders/customers/products', [
    'as' => 'admin.orders.customers.products.plus',
    'uses' => 'OrderProductsController@index',
    'middleware' => 'can:admin.orders.customers.products.plus',
]);
