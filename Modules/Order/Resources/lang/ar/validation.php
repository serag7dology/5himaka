...
return [
    ...
    'shipping.first_name.required_if'=> 'shipping first name is required if ship_to_different_address is true',
    'shipping.last_name.required_if'=> 'shipping last name is required if ship_to_different_address is true',
    'shipping.address_1.required_if'=> 'shipping address 1 is required if ship_to_different_address is true',
    'shipping.city.required_if'=> 'shipping city is required if ship_to_different_address is true',
    'shipping.zip.required_if'=>  'shipping zip is required if ship_to_different_address is true',
    'shipping.country.required_if'=> 'shipping country is required if ship_to_different_address is true',
    'shipping.state.required_if'=> 'shipping state is required if ship_to_different_address is true',
