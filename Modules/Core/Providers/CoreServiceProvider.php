...
class CoreServiceProvider extends ServiceProvider
{
    ...
    protected $middleware = [
        ...
        'checkPassword' => \Modules\Core\Http\Middleware\CheckPassword::class,
        'changeLanguage'=> \Modules\Core\Http\Middleware\ChangeLanguage::class,
        'checkUserToken'=> \Modules\Core\Http\Middleware\CheckUserToken::class,
