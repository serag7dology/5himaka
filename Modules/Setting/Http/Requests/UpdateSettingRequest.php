...
class UpdateSettingRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'fawry_enabled' => 'required|boolean',
            'fawry_label' => 'required_if:fawry_enabled,1',
            'fawry_description' => 'required_if:fawry_enabled,1',
            'fawry_merchant_code' => 'required_if:fawry_enabled,1',
            'fawry_merchant_sec_key' => 'required_if:fawry_enabled,1',
