                            ...
                            <div id="general-information" class="tab-pane fade in active">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        {{ Form::checkbox('has_document', trans('category::attributes.has_document'), trans('category::categories.form.has_document'), $errors,false) }}
                                        {{ Form::wysiwyg('documents', trans('category::attributes.documents'), $errors, null, ['labelCol' => 3]) }}
                                    </div>
                                </div>
                            </div>
