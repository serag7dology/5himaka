 ...
 *
 */
class AdultEntertainment extends BaseType implements EntertainmentBusinessContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
