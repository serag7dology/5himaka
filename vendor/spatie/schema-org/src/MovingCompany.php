 ...
 *
 */
class MovingCompany extends BaseType implements HomeAndConstructionBusinessContract, LocalBusinessContract, OrganizationContract, PlaceContract, ThingContract
{
    /**
